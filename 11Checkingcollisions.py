...
def obstacle_movement(obstacle_rect_list):
    if obstacle_rect_list:
        ...
        obstacle_rect_list = [obstacle for obstacle in obstacle_rect_list if obstacle.x > -100 ] # this only gives us the obejects which have x >-50 to keep the list clean
